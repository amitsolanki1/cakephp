      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          ...
          <div class="col-lg-7 pl-lg-5 align-self">
            ...
            <a href="<?= $this->Url->build(['controller'=>'pages','action'=>'about'])?>" class="btn btn-style btn-primary mt-lg-5 mt-4">Read More</a>
          </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 whybox-wrap-img mt-lg-0 mt-5 pl-lg-5">
        <div class="w3l-img-hr position-relative">
          <img src="<?= $this->Url->image('pic-3.png')?>" alt="" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          <div class="col-lg-6 left-wthree-img">
            <img src="<?= $this->Url->image('b2.jpg')?>" class="img-fluid radius-image" alt="">
      ...
      <div class="container py-md-5 py-3">
        ...
        <div class="row team-row pt-3 mt-3">
          <div class="col-lg-3 col-6 team-wrap mt-4 pt-lg-2">
            <div class="team-info">
              <div class="column position-relative img-circle">
                <a href="#url"><img src="<?= $this->Url->image('team1.jpg')?>" alt="" class="img-fluid" /></a>
              </div>
          ...
          <div class="col-lg-3 col-6 team-wrap mt-4 pt-lg-2">
            <div class="team-info">
              <div class="column position-relative img-circle">
                <a href="#url"><img src="<?= $this->Url->image('team2.jpg')?>" alt="" class="img-fluid" /></a>
              </div>
              <div class="column-btm">
          ...
          <div class="col-lg-3 col-6 team-wrap mt-4 pt-lg-2">
            <div class="team-info">
              <div class="column position-relative img-circle">
                <a href="#url"><img src="<?= $this->Url->image('team3.jpg')?>" alt="" class="img-fluid" /></a>
              </div>
              <div class="column-btm">
          ...
          <div class="col-lg-3 col-6 team-wrap mt-4 pt-lg-2">
            <div class="team-info">
              <div class="column position-relative img-circle">
                <a href="#url"><img src="<?= $this->Url->image('team4.jpg')?>" alt="" class="img-fluid" /></a>
              </div>
              <div class="column-btm">
