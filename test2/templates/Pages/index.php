    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 bannerhny-info pr-lg-5">
          ...
          <a class="btn btn-style mt-sm-5 mt-4 mr-2" href="<?= $this->Url->build(['controller'=>'pages','action'=>'about'])?>">
            Read More</a>
        </div>
        <div class="col-lg-6 bannerhny-info-img mt-lg-0 mt-5 pl-lg-5">
          <img src="<?= $this->Url->image('pic-1.png') ?>" alt="" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w3l-content-1 py-5">
    <div class="container py-lg-5 py-md-4 py-2">
      <div class="w3l-content-inf text-center">
        ...
        <a class="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="<?= $this->Url->build(['controller'=>'pages','action'=>'about'])?>">
          Read More</a>
      </div>
    </div>
  </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 whybox-wrap-img mt-lg-0 mt-5 pl-lg-5">
          <div class="w3l-img-hr position-relative">
            <img src="<?= $this->Url->image('pic-4.png') ?>" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row mt-4 py-md-2 mb-md-4">
          <div class="col-lg-6 item">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="<?= $this->Url->image('team1.jpg') ?>" class="img-responsive"
          ...
          <div class="col-lg-6 item mt-lg-0 mt-5">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="<?= $this->Url->image('team2.jpg')?>" class="img-responsive"
                    alt="placeholder image"></a>
                <div class="people-info align-self">
